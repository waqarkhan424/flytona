    ...
    <header className="bg-white shadow-md sticky top-0 z-50 border-b">
      <div className="max-w-7xl mx-auto px-4 py-2 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center justify-between w-full md:w-auto">
          ...
          >
            <img src="/rgt-logo.webp" alt="Flytona" className="h-8" />
          </Link>
          <div className="text-sm mt-2 md:mt-0 md:ml-6 flex flex-col md:flex-row md:items-center gap-1 md:gap-4 text-gray-600">
            <div className="flex items-center gap-1">
              <FaPhone className="text-blue-600" /> +92 51 111 786 785
            </div>
            <div className="flex items-center gap-1">
              <FaWhatsapp className="text-green-500" /> +92 311 786 785
            </div>
          </div>
        </div>
      ...
      {/* Navigation */}
      <nav className="bg-blue-600 text-white text-sm font-semibold">
